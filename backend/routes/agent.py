"""
Agent Routes for ElevenLabs Conversational AI

These endpoints provide:
1. Signed URL generation for client WebSocket connection
2. Tool endpoints that the ElevenLabs agent calls for syllabus data
"""
...
async def get_agent_config():
    ...
    Returns the system prompt and tool definitions.
    """
    return elevenlabs_service.get_agent_config()
