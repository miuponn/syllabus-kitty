...
export default function AuthButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-6 py-2 bg-white text-gray-700 font-semibold rounded-full border-2 border-gray-200 hover:border-purple-500 hover:shadow-lg hover:scale-105 transition-all duration-200"
    >
